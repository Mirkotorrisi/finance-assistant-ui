...
export default function DashboardPage() {
  ...
  function handleBubbleClick(category: string, startDate: string, endDate: string) {
    const filters: TransactionFilters = { category, start_date: startDate, end_date: endDate }
    setDraft(filters)
    setApplied(filters)
